...
```console
pip install test-pypi-darwin-py312-test
```
...
```console
pip install git+ssh://git@github.com/whiteprints-tests/test-pypi-darwin-py312-test
```
...
[package]: https://pypi.org/project/test-pypi-darwin-py312-test
