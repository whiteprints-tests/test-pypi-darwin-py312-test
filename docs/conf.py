...
project = "test pypi darwin py312-test"
...
release = metadata.version("test_pypi_darwin_py312_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-pypi-darwin-py312-test",
            "icon": "fa-brands fa-square-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/test-pypi-darwin-py312-test",
