...
<div align="center">
    ...
    <p>
        <a href="https://www.python.org"><img alt="PyPI - Python Version" src="https://img.shields.io/pypi/pyversions/test-pypi-darwin-py312-test.svg?logo=Python&logoColor=ffd43b"/></a>
        <a href="https://pypi.org/project/test-pypi-darwin-py312-test"><img alt="PyPI - Project Version" src="https://img.shields.io/pypi/v/test-pypi-darwin-py312-test.svg?logo=PyPI&logoColor=ffd43b"/></a>
        ...
        <a href="https://github.com/whiteprints-tests/test-pypi-darwin-py312-test/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-pypi-darwin-py312-test.svg?logo=GitHub"></a>
